...
import ResultsPanelComponent from './ResultsPanel/ResultsPanelComponent';
...
const RunComponent: React.FC<RunComponentProps> = ({
    ...
    useEffect(() => {
        ...
        setSelectedFiles(persistentState?.selectedFiles || files.map(file => file.id));
        // setSelectAll(true);
    }, [files]);
    ...
    }, [persistentState, initializeParams, getFirstActiveMethod, files]);
    ...
    return (
        <div >
            ...
            <ResultsPanelComponent
                solution={solution}
                isExpanded={showResultsPanel}
                onToggle={toggleResultsPanel}
