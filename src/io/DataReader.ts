...
import { CDirection, CTypeOfMovement, Direction, TypeOfMovement, isDefined, isNumber } from "../utils"
import {
    assertNumberDefined,
 ...
 */
export function readStriatedFaultPlane(obj: Record<string, any>, plane: Plane, striation: Striation, result: DataStatus): void {
